...
bool ApplicationClass::Initialize(HINSTANCE hinstance, HWND hwnd, int screenWidth, int screenHeight)
{
	...
	result = m_Model->Initialize(m_Direct3D->GetDevice(), L"../Project/data/seafloor.dds", "../Project/data/floor.txt");
	if(!result)
	{
	...
	result = m_Terrain->Initialize(m_Direct3D->GetDevice(), "../Project/data/heightmap01.bmp", L"../Project/data/dirt01.dds", "../Project/data/colorm01.bmp");
	if(!result)
	{
	...
	result = m_SkyDome->Initilize(m_Direct3D->GetDevice());
	if(!result)
	{
	...
	result = m_SkyPlane->Initilize(m_Direct3D->GetDevice(), L"../Project/data/cloud001.dds", L"../Project/data/cloud002.dds");
	if(!result)
	{
	...
	result = m_SkyPlaneShader->Intilize(m_Direct3D->GetDevice(), hwnd);
	if(!result)
	{
...
bool ApplicationClass::RenderGraphics()
{
	...
	result = m_ShaderManager->TerrainRender(m_Direct3D->GetDeviceContext(), m_Terrain->GetIndexCount(), worldMatrix, viewMatrix, projectionMatrix, 
